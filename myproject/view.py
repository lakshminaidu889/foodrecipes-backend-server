...
# def home(request):
#     if(request.method=="GET"):
#         return HttpResponse(request,"its working..........")
#     else:
#         return HttpResponse(request,"its not working................")
    # return HttpResponse("hello world")
# def defaultpage(request):
#     if(request.method=='GET'):
#         return render(request,"templats\index.html")
#     else:
#         return render(request,)
#         print(request,"this is not a get request")
#     # return HttpResponse("<h1>this is default page</h1>")
